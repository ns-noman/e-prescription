...
<section class="content">
    <?php echo $success_msg; ?>
          <?php echo $error_msg; ?>
    <form class="form-horizontal" action="<?php echo base_url() . "add-patient-vital/" . $app_info->appointment_id; ?>" method="post" enctype="multipart/form-data"  role="form">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                        <div class="form-group">
                            <div class="col-sm-6">
                              <input type="hidden" class="form-control" id="patient_reg" name="patient_reg">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="patient_temperature_f" id="patient_temperature_f" value="<?php echo set_value('patient_temperature_f'); ?>" step="0.01">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="patient_temperature_c" id="patient_temperature_c" value="<?php echo set_value('patient_temperature_c'); ?>" step="0.01">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="patient_weight_kg" id="patient_weight_kg" value="<?php echo set_value('patient_weight_kg'); ?>" step="0.01">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="patient_weight_lbs" id="patient_weight_lbs" readonly>
                          ...
                          <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="patient_respiration" id="patient_respiration" value="<?php echo set_value('patient_respiration'); ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="patient_pulse" id="patient_pulse" value="<?php echo set_value('patient_pulse'); ?>">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="patient_bp_sys" id="patient_bp_sys" value="<?php echo set_value('patient_bp_sys'); ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="patient_bp_dia" id="patient_bp_dia" value="<?php echo set_value('patient_bp_dia'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="patient_other" id="patient_other" value="<?php echo set_value('patient_other'); ?>">
