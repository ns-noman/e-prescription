...
<!--                 <div class="form-group">
                    <label for="weight_kg" class="col-sm-5 control-label">Weight (Kg)</label>
                    <div class="col-sm-7">
                        ...
                        <?php
                            ...
                            foreach($patient_info as $patient){ ?>
                                <tr>
                                    ...
                                    <td><!-- <a class="btn btn-primary btn-xs" href="<?php //echo base_url() . "appointment-entry/" . $patient->patient_id; ?>">
                                            Appointment
                                        </a> -->
                                    </td>
                                </tr>
