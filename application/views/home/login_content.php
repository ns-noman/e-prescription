...
?>
    ...
    <form action="<?php echo base_url(); ?>admin-login" method="post">
      ...
      <?php
        ...
        <div class="form-group" style="padding-bottom: 15px;">
            <label class="text-red" style="float: left; margin-right: 20px;"> Answer in digits : <?php echo convert_number_to_words($one); ?> + <?php echo $two; ?> = </label><input type="number" class="col-xs-3" name="cap" class="form-control" required>
        </div>
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
   ...
   <!-- <a href="<?php echo base_url(); ?>">Serach Test</a> -->
  </div>