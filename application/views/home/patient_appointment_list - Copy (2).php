    ...
    <?php echo $error_msg; ?>
        <div class="col-md-12">
            ...
            foreach ($doctors as $doctor) { 
                $doctor_patient =  $this->prescription_model->get_datewise_doctor_appointment_count($date, $doctor->doctor_id);
                                    if ($doctor_patient) {
                                        $x = 1;
                ?>
                        ...
                        <div class="col-md-12">
                            <div>
                                ...
                                <table style="margin-top: 10px;">
                                    <tr>
                                        <th colspan="6" style="background-color: #dfdfdf;"><?php echo $doctor->doctor_name; ?> (Total Visit : <?php echo count($doctor_patient); ?>)</th>
                                    </tr>
                                    <tr>
                                        <th>SL</th>
                                        <th>Reg. No</th>
