...
<section class="content">
      ...
      <!-- form row -->
    <div class="row">
        <form class="form-horizontal" action="<?php echo base_url() . "save-doctor-template"; ?>" method="post" enctype="multipart/form-data"  role="form">
            <div class="col-md-12">
                ...
                <div class="box box-info box-solid">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="template_name" id="template_name" value="<?php echo set_value('template_name'); ?>" required>
