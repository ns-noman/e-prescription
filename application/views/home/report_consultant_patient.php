                ...
                <div id="printableArea" style="margin-left:2px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                <br>
                                <center><span class="top-title">Visited Patient List of Each Consultant</span></center>
                                <br>
                                <table>
                                    <tr>
                                ...
                                <table style="margin-top: 10px;">
                                    <tr>
                                        <th colspan="5" style="background-color: #dfdfdf;"><?php echo $doctor->doctor_name; ?> (Total Visit : <?php echo count($doctor_patient); ?>)</th>
                                    </tr>
                                    <tr>
                                        <th width="50">SL</th>
