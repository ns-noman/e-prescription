              ...
              <div class="box-body table-responsiv">
                <div id="printableArea" style="margin-left:2px;">
                    ...
                    <div class="row" style="margin-top: 2px;">
                        ...
                        <div class="col-md-12 drsign">
                            <div class="pull-right" style="font-size: 8pt; line-height: 13px; text-align: right;">
                            <?php if($app_info->doctor_seal){
                              echo $app_info->doctor_seal;
                            }else{
                                echo $app_info->doctor_name."<br>".$app_info->doctor_designation;
                            }
                             ?>
                        </div>
                        </div>
