...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">New Manufacturer</li>
    </ol>
</section>
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="<?php echo base_url();?>save-manufacturer" method="post" enctype="multipart/form-data"  role="form">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="man_cr_amount" id="man_cr_amount" value="<?php echo set_value('man_cr_amount'); ?>" step="0.01">
                        <span style="color:red;font-size: 10px;float: left;"><?php echo form_error('man_cr_amount'); ?></span>
                    </div>
                </div>

                <div class="form-group">
                    <label for="man_cr_amount_dt" class="col-sm-2 control-label">Daily Credit Amount</label>
                    <div class="col-sm-4">
                        <input type="number" class="form-control" name="man_cr_amount_dt" id="man_cr_amount_dt" value="<?php echo set_value('man_cr_amount_dt'); ?>" step="0.01">
