...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-mini"><b>SDL</b>Pharma</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SDL</b>Pharma</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>log-out" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          <a href="#">
          <i class="fa fa-balance-scale"></i> <span>Sales</span>
          <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>new-sales"><i class="glyphicon glyphicon-tasks"></i>New Sales</a></li>
          <li><a href="<?php echo base_url(); ?>manage-invoice"><i class="glyphicon glyphicon-tasks"></i>Manage Invoice</a></li>
          </ul>
        </li>
      <?php } ?>
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          <a href="#">
          <i class="fa fa-medkit"></i> <span>Product</span>
          <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>add-product"><i class="glyphicon glyphicon-tasks"></i>Manufacturer Wise Product</a></li>
          <!-- <li><a href="<?php echo base_url(); ?>add-medicine"><i class="glyphicon glyphicon-tasks"></i>Add Product</a></li> -->
          <!-- <li><a href="<?php echo base_url(); ?>manage-medicine"><i class="glyphicon glyphicon-list"></i>Manage Product</a></li>   -->
          </ul>
        </li>
      <?php } ?>
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          <a href="#">
          <i class="fa fa-clone"></i> <span>Requisition</span>
          <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>manufacturer-wise-requisition"><i class="glyphicon glyphicon-tasks"></i>Add Requisition</a></li>
          <li><a href="<?php echo base_url(); ?>manage-pending-requisition"><i class="glyphicon glyphicon-tasks"></i>Pending Requisitions</a></li>
          <li><a href="<?php echo base_url(); ?>manage-approved-requisition"><i class="glyphicon glyphicon-tasks"></i>Approved Requisitions</a></li>
          <li><a href="<?php echo base_url(); ?>manage-canceled-requisition"><i class="glyphicon glyphicon-tasks"></i>Canceled Requisitions</a></li>
          </ul>
        </li>
      <?php } ?>
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          <a href="#">
          <i class="fa fa-archive"></i> <span>Product Receive</span>
          <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>product-receive"><i class="glyphicon glyphicon-tasks"></i>Receive Entry</a></li>
          <li><a href="<?php echo base_url(); ?>manage-product-receive"><i class="glyphicon glyphicon-tasks"></i>Manage Receive</a></li>
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          <a href="#">
          <i class="fa fa-circle-o-notch"></i> <span>Purchase Return</span>
          <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>product-purchase-return"><i class="glyphicon glyphicon-tasks"></i>Return Entry</a></li>
          <li><a href="<?php echo base_url(); ?>manage-purchase-return"><i class="glyphicon glyphicon-tasks"></i>Manage Return</a></li>
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          <a href="#">
          <i class="fa fa-bar-chart-o"></i> <span>Product Stock</span>
          <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>product-stock-list"><i class="glyphicon glyphicon-tasks"></i>Current Stock List</a></li>
          <li><a href="<?php echo base_url(); ?>manufacturer-wise-stock"><i class="glyphicon glyphicon-tasks"></i>Manufacturer Wise Stock</a></li>
          <li><a href="<?php echo base_url(); ?>date-wise-stock"><i class="glyphicon glyphicon-tasks"></i>Date Wise Stock</a></li>
          </ul>
        </li>
      <?php } ?>
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>all-report"><i class="glyphicon glyphicon-tasks"></i>Todays Report</a></li>
          <li><a href="<?php echo base_url(); ?>sales-report"><i class="glyphicon glyphicon-tasks"></i>Sales Report</a></li>
          <li><a href="<?php echo base_url(); ?>purchase-report"><i class="glyphicon glyphicon-tasks"></i>Purchase Report</a></li>
          </ul>
        </li>
      <?php } ?>
      ...
      <?php if($this->session->userdata('user_type') == "Super Admin" or $this->session->userdata('user_type') == "Admin" or $this->session->userdata('user_type') == "Client"){ ?>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url(); ?>medicine-type"><i class="glyphicon glyphicon-tasks"></i> Medicine Type</a></li>     
          <li><a href="<?php echo base_url(); ?>medicine-category"><i class="glyphicon glyphicon-list"></i> Medicine Category</a></li>
