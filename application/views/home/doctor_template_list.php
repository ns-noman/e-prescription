                ...
                <table class="table table-bordered table-striped table-hover example2">
                  ...
                  <tr>
                    ...
                    foreach($templates as $template){
                        ...
                        <td>
                            <!-- <a class="btn btn-primary btn-xs" href="<?php //echo base_url() . "doctor-template-detail/" . $template->template_id; ?>">
                    ...
                    foreach($self_templates as $self){
                        ?>
                        <td style="width:12px;"><?php echo $x++; ?>.</td>
                        <td><?php echo $self->template_name;?></td>
                        <td>
                            Self
                        </td>
                        <td>
                            <a class="btn btn-primary btn-xs" href="<?php echo base_url() . "doctor-template-detail/" . $self->template_id; ?>">
                                <i class="glyphicon glyphicon-pencil"></i>
                                View
                            </a>
                        </td>
